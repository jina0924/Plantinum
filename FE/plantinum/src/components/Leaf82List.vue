<template>
  <div class="leaf82-sell">
    ...
    <div class="leaf82-list-box row" v-if="isSell">
      ...
      <!-- 리스트가 있을 때 -->
      <div class="leaf82-list col-sm-8 col-md-6 col-0 row d-flex justify-content-center" v-if="!searchList">
      <!-- <div class="leaf82-list col-sm-8 col-md-6 col-0 row d-flex justify-content-center"> -->
        <div class="item px-2 pb-2">
          ...
          <div class="item-info">
            <p class="name">알로에</p>
            <p class="price">7,000 원</p>
            <p class="addr">경기도 수원시 장안구</p>
      ...
      <div class="leaf82-list col-sm-8 col-md-6 col-0 mt-5" v-if="!!searchList">
